function createUnityInstance(e, r, t) {
  ...
  document.addEventListener('webkitfullscreenchange', function (r) {
    ...
    t === e
      ? e.style.width &&
        ((p = e.style.width), (m = e.style.height), (e.style.width = '100%'), (e.style.height = '100%'))
    ...
    (c.XMLHttpRequest = (function () {
              ...
              t.enabled &&
                ...
                (304 == r.status
                  ? ((t.result.revalidated = t.result.accessed),
                    ...
                    e("'" + t.result.url + "' successfully revalidated and served from the indexedDB cache"))
                  : 200 == r.status
                  ? ((t.result = o(t.result.url, t.company, t.product, t.result.accessed, r)),
                    (t.revalidated = !0),
                    l.execute(
                      i.name,
                      'put',
      ...
      n.prototype.execute = function (e, r, t, n, o) {
        if (this.database)
          try {
            var a = this.database
              .transaction([e], ['put', 'delete', 'clear'].indexOf(r) != -1 ? 'readwrite' : 'readonly')
              .objectStore(e)
      ...
      ;(a.prototype.send = function (r) {
          ...
          o.enabled
            ? void l.execute(
                ...
                function (r) {
                  ...
                  if (((o.result = r), (o.result.accessed = Date.now()), 'immutable' == o.control))
                    (o.revalidated = !0),
        ...
        (a.prototype.open = function (e, t, n, a, s) {
          return (
            (this.cache.result = o(r(t), this.cache.company, this.cache.product, Date.now())),
            (this.cache.enabled =
      ...
      c.SystemInfo.hasWebGL
        ? c.SystemInfo.hasWasm
          ? (1 == c.SystemInfo.hasWebGL &&
              c.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'),
